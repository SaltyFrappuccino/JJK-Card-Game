...
| Несгибаемая Воля (Итадори) | Отрицательный | Ваше ХП может опускаться до -3500. По окончании эффекта вы проигрываете. |
...
| Контратака 'Манджи-Кик' (Итадори) | Положительный | Следующая атакующая карта (не РТ), которую вы сыграете против Юдзи, будет отменена. |