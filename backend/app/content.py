    ...
    Character(
        ...
        unique_cards=[
            ...
            Card(
                ...
                rarity=Rarity.LEGENDARY,
                cost=30000,
                description="**Условие:** вы должны атаковать 5 раз картами, игнорирующими блок. Вы получаете постоянный эффект: урон от вражеских \"Ударов\" по вам снижен на 50%, вы получаете 500 блока в начале раунда, а ваш \"Удар\" наносит урон в 3 раза больше (900)."
            ),
            Card(
    ...
    Character(
        ...
        unique_cards=[
            Card(
                ...
                rarity=Rarity.UNCOMMON,
                cost=4000,
                description="Атакует основную цель, а также цель справа и слева от неё, нанося каждому по 300 урона"
            ),
            Card(
