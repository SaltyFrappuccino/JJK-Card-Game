...
| Искажение души (Махито) | Отрицательный | Ваш блок аннулируется и на вас накладывается эффект "Искажение Рук". |
| **Ловкие Ноги (Махито)** | Положительный | 25% шанс уклониться от любой атаки по одной цели (не работает против AoE и урона от РТ). |
| **Большие Руки (Махито)** | Положительный | Максимальный размер руки увеличен на 1. |
| **Длинные Руки (Махито)** | Положительный | Каждый раз, когда другой игрок разыгрывает на вас карту, есть 25% шанс получить копию этой карты себе в руку (стоимость копии х1.5). |
| **Искажение Рук (Махито)** | Отрицательный | Максимальный размер руки уменьшен на 1. В начале своего хода, если у вас карт больше нового лимита, должны сбросить лишние. |
| **Косоглазие (Махито)** | Положительный | Каждый раз, когда вас атакуют, есть 25% шанс, что атака будет перенаправлена на цель, на которую вы наложили этот эффект. |
